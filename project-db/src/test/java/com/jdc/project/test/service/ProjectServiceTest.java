...
public class ProjectServiceTest {
	...
	@Order(1)
	@ParameterizedTest
	@ValueSource(strings = { "7,Test Project 1,Just Testing,3,20220602,6",
			"7,Test Project 2,Just Testing,4,20220615,12", "7,Test Project 3,Just Testing,5,20220625,18", })
	...
	@Order(2)
	@ParameterizedTest
	@ValueSource(strings = { ",Just Testing,3,20220602,6", ",Just Testing,4,20220615,12",
	...
	@Order(3)
	@ParameterizedTest
	@ValueSource(strings = { "Test Project 1,Just Testing,,20220602,6", "Test Project 2,Just Testing,,20220615,12",
	...
	@Order(4)
	@ParameterizedTest
	@ValueSource(strings = { "Test Project 1,Just Testing,3,,6", "Test Project 2,Just Testing,4,,12",
	...
	@Order(5)
	@ParameterizedTest
	@ValueSource(strings = { "1,Book Store,Shopping System,2,2022-05-10,6,Aung Aung,aungaung",
	...
	@Order(6)
	@ParameterizedTest
	@CsvSource({ ",,,,6", "project,,,,1", ",Aung,,,5", ",,2022-05-01,,3", ",,,2022-05-01,4", })
	...
	@Order(7)
	@ParameterizedTest
	@CsvSource({ "1,Book Catalog,Book Info Microservice,2022-10-12,18,1",
